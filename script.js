...
function initVisualRefreshMotion() {
    ...
    if (hero) {
        hero.addEventListener('mousemove', function(event) {
            ...
            var x = ((event.clientX - rect.left) / rect.width - 0.5) * 24;
            var y = ((event.clientY - rect.top) / rect.height - 0.5) * 18;
            hero.style.setProperty('--ai-pointer-x', x.toFixed(2) + 'px');
            hero.style.setProperty('--ai-pointer-y', y.toFixed(2) + 'px');
        });
        hero.addEventListener('mouseleave', function() {
            hero.style.setProperty('--ai-pointer-x', '0px');
            hero.style.setProperty('--ai-pointer-y', '0px');
        });
    }
}

document.addEventListener('DOMContentLoaded', initVisualRefreshMotion);
